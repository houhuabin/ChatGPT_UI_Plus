...
const Popup = () => {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: "h-screen" },
        ...
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("input", { value: name, onChange: (e) => setName(e.target.value), className: "bg-gray ring-black px-4 py-4", type: "text", name: "name", placeholder: "Enter a word.." }),
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("button", { onClick: handleSubmit, className: "py-4 px-3 bg-indigo-500 text-white m-2" }, "Submit")));
};
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["vendors-node_modules_css-loader_dist_runtime_api_js-node_modules_css-loader_dist_runtime_sour-b53f7e","src_assets_css_tailwind_css"], () => (__webpack_require__("./src/popup/index.tsx")))
