...
function createLeftSVG() {
    ...
    outerDiv.style.cssText = "flex-shrink: 0; flex-grow: 0; border-radius: 3px; color: rgba(55, 53, 47, 0.65); width: 22px; height: 22px; display: flex; align-items: center; justify-content: center; margin-right: 0px;";

    // Inner div
    const innerDiv = document.createElement('div');
    innerDiv.setAttribute('role', 'button');
    innerDiv.setAttribute('tabindex', '0');
    innerDiv.setAttribute('aria-describedby', ':rh:');
    ...
    svg.className = 'chevronDownRoundedThick';
    ...
    path.setAttribute('d', 'M1 3L6 9L11 3 M6 9V1');
