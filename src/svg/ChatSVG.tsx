...
export default function ChatSVG() {
    return (
        <svg viewBox="0 0 16 16" className="document-svg">
            ...
            <line x1="3.679823" y1="7.92677" x2="10.714013" y2="7.92677" className='svg-lighter-color'></line>
            <line x1="3.679823" y1="10.92677" x2="10.714013" y2="10.92677" className='svg-lighter-color'></line>
        </svg>
