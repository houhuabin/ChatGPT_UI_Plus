...
import './ToggleSVG.scss'

export default function ToggleSVG({ rotateDegree }) {
    // console.log(rotateDegree + "   rotateDegree=================");
    return (
        <svg viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg" className="ToggleSVG" style={{ transform: `rotate(${rotateDegree})` }}>
            <path
